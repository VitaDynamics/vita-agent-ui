...
export const TakeActionTool: React.FC<TakeActionToolProps> = ({ args, result }) => {
    ...
    const message: string | undefined = normalized.message ?? (typeof result === 'string' ? result : undefined);
